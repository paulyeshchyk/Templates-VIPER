...
class NNSuperbViewController: UIViewController, NNSuperbViewProtocol, UITextFieldDelegate  {
	...
	//MARK: - NNSuperbViewProtocol
    var output:NNSuperbPresenterProtocol?
